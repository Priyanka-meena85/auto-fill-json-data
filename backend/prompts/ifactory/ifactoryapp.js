...
- CRITICAL: You MUST use ONLY two links for buttons or hyperlinks in the ENTIRE PAGE: "https://ifactoryapp.com/support" (Secondary CTA, e.g., "Learn More", "Contact Us", "Explore Features") and "https://calendly.com/contact-ifactoryapp/30min" (Primary CTA, e.g., "Book a Demo", "Get Started"). Every CTA section MUST include BOTH of these buttons side-by-side.
...
- CRITICAL: Use beautiful CSS properties like subtle, soft box-shadows (e.g., 'box-shadow: 0 4px 12px rgba(96,93,186,0.15)'), elegant gradients, and rich background contrasts using strictly #ffffff and #605dba.
...
- CRITICAL SECTION STYLING: Avoid repeating the same solid #605dba background for every section. Alternate between pure white #ffffff backgrounds (with #605dba text/borders) and #605dba backgrounds (with #ffffff text). Keep section heights balanced and avoid large empty areas. DO NOT USE ANY OTHER COLORS.
